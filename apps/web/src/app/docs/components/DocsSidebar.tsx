...
const docSections: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'architecture', title: 'Arquitectura', href: '/docs#architecture' },
      { id: 'database', title: 'Base de Datos', href: '/docs#database' },
      { id: 'rag-system', title: 'Sistema RAG', href: '/docs#rag-system' },
      { id: 'document-processing', title: 'Procesamiento', href: '/docs#document-processing' },
    ],
  },
  {
    id: 'api',
    ...
    items: [
      { id: 'authentication', title: 'Autenticación', href: '/docs#authentication' },
      { id: 'documents-api', title: 'Documentos', href: '/docs#documents-api' },
      { id: 'chat-api', title: 'Chat & RAG', href: '/docs#chat-api' },
      { id: 'error-codes', title: 'Códigos de Error', href: '/docs#error-codes' },
    ],
  },
  {
    id: 'troubleshooting',
