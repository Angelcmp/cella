      ...
      <div className="p-1">
        ...
        {file && !uploading && (
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-[var(--zen-hover)] border border-[var(--zen-line)]">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-[var(--primary-fixed)] text-white text-(length:--zen-fs-body) font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
            >
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="w-full h-1.5 rounded-full bg-[var(--zen-hover)] mt-2 overflow-hidden">
                  <div
