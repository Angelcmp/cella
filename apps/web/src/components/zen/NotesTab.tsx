    ...
    <div className="p-4 space-y-3">
      ...
      <div className="rounded-xl border border-[var(--outline-variant)] p-2">
        <textarea
          ...
          className="w-full resize-none bg-transparent text-(length:--zen-fs-body) text-[var(--on-surface)] placeholder:text-[var(--on-surface-variant)]/40 outline-none leading-relaxed min-h-[52px]"
        />
        <div className="flex items-center justify-end mt-1">
          <button
            onClick={createNote}
            disabled={saving || !draft.trim()}
            className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-[var(--primary-fixed)] text-white text-(length:--zen-fs-secondary) font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
          >
              ...
              {editingId === note.id ? (
                <div>
                  <textarea
                    ...
                    className="w-full resize-none bg-transparent text-(length:--zen-fs-body) text-[var(--on-surface)] outline-none leading-relaxed min-h-[48px]"
                    autoFocus
                  />
                  <div className="flex items-center justify-end gap-2 mt-1">
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="p-1 text-[var(--primary-fixed)] hover:opacity-80"
                    >
                ...
                <div>
                  <p className="text-(length:--zen-fs-body) text-[var(--on-surface-variant)] leading-relaxed whitespace-pre-wrap">
                    {note.content}
                  </p>
                  <div className="flex items-center justify-between mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-1 text-[var(--on-surface-variant)] hover:text-red-500"
                        title="Eliminar"
                      >
